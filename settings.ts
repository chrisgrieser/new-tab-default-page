...
export class DefaultNewTabPageSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.setDesc("What to open when a new tab is created. (Except for the new tab page, the respective plugin needs to be enabled.)")
			.addDropdown(dropdown => { dropdown
				...
				.addOption("periodic-notes:open-daily-note", "Daily Note (Periodic Notes Plugin)")
